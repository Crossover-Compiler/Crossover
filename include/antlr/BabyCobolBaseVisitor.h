...
public:
  ...
  virtual std::any visitIdentifierAtomic(BabyCobolParser::IdentifierAtomicContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitVar(BabyCobolParser::VarContext *ctx) override {
    return visitChildren(ctx);
  }
